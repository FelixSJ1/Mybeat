...
<body>
    ...
    <div class="container">
        <div class="search-and-profile-header">
            ...
            <?php if ($idUsuarioLogado > 0): ?>
                <a href="ShowPerfil.php?id=<?= $idUsuarioLogado ?>" class="btn-meu-perfil" title="Ver seu perfil e seguidores">
                    @<?= htmlspecialchars($nomeUsuarioLogado) ?>
                </a>
            <?php endif; ?>
        </div>
