        ...
        <?php if (!empty($playlists)): ?>
          <div class="playlists-grid">
            <?php foreach ($playlists as $pl):
                ...
                // Link para a ação do controller que mostra detalhes da playlist
                $cardHref = "listar_giovana.php?controller=playlist&action=detalhes&id=" . $playlistId;
            ?>
              <div class="playlist-card">
                <a href="<?= htmlspecialchars($cardHref, ENT_QUOTES) ?>" class="playlist-cover-link" title="<?= htmlspecialchars($pl['nome_playlist'], ENT_QUOTES) ?>">
                ...
                <a href="<?= htmlspecialchars($cardHref, ENT_QUOTES) ?>" class="playlist-name-link">
